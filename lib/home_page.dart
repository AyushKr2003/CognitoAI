...
import 'package:cognito_ai/feature_box.dart';
import 'package:cognito_ai/openai_service.dart';
import 'package:cognito_ai/pallete.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> initTestToSpeech() async{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: BounceInDown(child: const Text('CognitoAI')),
        centerTitle: true,
        leading: IconButton(
          onPressed: () {},
                ...
                children: [
                  ...
                  SlideInLeft(
                    ...
                    child: const FeatureBox(
                      ...
                      headerText: 'Dall-E',
                      descriptionText:
                          'Get inspired and stay creative with your personal assistant powered by Dall_E',
                    ),
                  ),
                  SlideInLeft(
